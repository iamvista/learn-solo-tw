...
export default async function PrivacyPage() {
  ...
  return (
    <LegalPageLayout title="隱私權政策" lastUpdated={lastUpdated}>
      ...
      <p>
        歡迎您使用 {siteName}{" "}
        (以下稱「本平臺」)，為了保障您的權益，並打造更佳的服務，在您開始使用本網站前，請先詳讀本隱私權政策與使用條款（以下簡稱「本政策」）。
      </p>

      <h3>二、本政策適用範圍</h3>
      <p>
        本政策適用本平臺所有服務，包括提供內容註冊會員、發表留言或提問、購買商品或課程、報名活動。我們可能不定時推出新服務。若推出新服務使收集與使用個人資料的方式有變動，我們會提供變動的項目。除非推出的新服務有特別說明，否則這類服務仍須遵守本政策。
      </p>
      ...
      <ol>
        ...
        <li>
          ...
          Apple
          等社群登入工具），收集到有關您的個人資料。只有當您同意第三方或本平臺進行資料分享、或註冊成為會員時，我們才會使用。
        </li>
      </ol>
      ...
      <ol>
        ...
        <li>
          ...
          我們會使用向您收集到的電子郵件、社交媒體帳號與您互動。例如：若您參與本平臺舉辦的活動，我們會使用個人資料與您聯絡後續事宜。我們也可能在推出新服務時，寄送通知給您。
        </li>
        <li>
          <strong>保護本平臺使用者和一般大眾</strong> —
          我們會應用相關資料來改善本平臺所提供服務的穩定與安全，偵測與預防可能的濫用行為或安全性風險。
        </li>
      </ol>
      ...
      <ul>
        <li>
          ...
          Vercel、AWS、Cloudflare），以便本平臺所有服務順利運作。
        </li>
        <li>
      ...
      <h3>六、資料安全保護承諾</h3>
      <p>
        您的個人資料處理均依照中華民國法律予以處理，並以臺灣臺北地方法院為第一審管轄法院。我們致力為您的個人資料提供妥善保護，並採取適當的技術與安全維護措施（如
        HTTPS 加密傳輸）來協助保護您的個人資料安全。
      </p>

      <h3>七、您的個人資料保存、刪除和權利</h3>
      <p>依個人資料保護法，您可以與本平臺客服部聯絡請求行使以下權利：</p>
      <ul>
        <li>查詢或請求閱覽。</li>
        <li>製給複製本。</li>
        <li>補充或更正。</li>
      ...
      <p>
        上述權利之行使，本平臺可能依法酌收必要成本費用。若因不符合申請程序、法律規定、本網站依法負有保存義務或法律另有規定之情況者，則可能無法依您的要求辦理。
      </p>

      <h3>八、隱私權政策的異動</h3>
      <p>
        本平臺有權於任何時間修改或變更本政策之內容。當我們對本政策進行實質變更後，將適時透過網站公告或電子郵件通知您。
      </p>
